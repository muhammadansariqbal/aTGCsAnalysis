...
echo "WJets_Pt-100To250";hadd "WJets_Pt100To250_mu.root" $sourceDir"WJets_Pt100To250_mu.root" $sourceDir"WJets_Pt100To250-ext1_mu.root" $sourceDir"WJets_Pt100To250-ext4_mu.root"
echo "WJets_Pt-250To400";hadd "WJets_Pt250To400_mu.root" $sourceDir"WJets_Pt250To400_mu.root" $sourceDir"WJets_Pt250To400-ext1_mu.root" $sourceDir"WJets_Pt250To400-ext4_mu.root"
echo "WJets_Pt-400To600";hadd "WJets_Pt400To600_mu.root" $sourceDir"WJets_Pt400To600_mu.root" $sourceDir"WJets_Pt400To600-ext1_mu.root"
echo "WJets_Pt-600ToInf";hadd "WJets_Pt600ToInf_mu.root" $sourceDir"WJets_Pt600ToInf_mu.root" $sourceDir"WJets_Pt600ToInf-ext1_mu.root"
...
echo "WJets_Pt-100To250";hadd "WJets_Pt100To250_ele.root" $sourceDir"WJets_Pt100To250_ele.root" $sourceDir"WJets_Pt100To250-ext1_ele.root" $sourceDir"WJets_Pt100To250-ext4_ele.root"
echo "WJets_Pt-250To400";hadd "WJets_Pt250To400_ele.root" $sourceDir"WJets_Pt250To400_ele.root" $sourceDir"WJets_Pt250To400-ext1_ele.root" $sourceDir"WJets_Pt250To400-ext4_ele.root"
echo "WJets_Pt-400To600";hadd "WJets_Pt400To600_ele.root" $sourceDir"WJets_Pt400To600_ele.root" $sourceDir"WJets_Pt400To600-ext1_ele.root"
echo "WJets_Pt-600ToInf";hadd "WJets_Pt600ToInf_ele.root" $sourceDir"WJets_Pt600ToInf_ele.root" $sourceDir"WJets_Pt600ToInf-ext1_ele.root"
